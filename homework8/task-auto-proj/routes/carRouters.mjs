...
router.post("/create/:id?", uploadManager.getUploadStorage("uploads").single("imgSrc"), checkSchema(carValidator.carValidationSchema), carValidator.checkFile, carController.formAction)
